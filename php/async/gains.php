...
use ccxt\async\abstract\gains as Exchange;
...
class gains extends Exchange {
    ...
    public function fetch_ohlcv(string $symbol, $timeframe = '1m', ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $timeframe, $since, $limit, $params) {
            ...
            $response = Async\await($this->publicGetOhlcv ($this->extend($request, $params)));
            // array(
            //     array(
    ...
    public function fetch_leverage_tiers(?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbols, $params) {
            ...
            // }
            Async\await($this->load_markets());
            $response = Async\await($this->privateGetLeverageTiers ($params));
    ...
    public function set_leverage(?int $leverage, ?string $symbol = null, $params = array ()) {
        return Async\async(function () use ($leverage, $symbol, $params) {
            ...
            return Async\await($this->privatePostLeverage ($this->extend($request, $params)));
            // {
            //     "symbol" => "BTC/USDT",
            //     "longLeverage" => 100,
            //     "shortLeverage" => 75
